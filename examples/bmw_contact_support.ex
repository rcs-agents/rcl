import RCSAgents / Library / BMW Agent as BMW

agent BMW Support Agent

  displayName: BMW.displayName
  ...
  messages Messages
    ...
    message EndConversationThanksMessage
      text: "Thank you for contacting BMW Digital Support! Have a wonderful day. If you need further assistance, feel free to return to the main menu."
