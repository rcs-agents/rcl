...
export const ifKeyword: MatchRule = {
    key: 'if-keyword',
    scope: scopes.keywords.conditional,
    match: R.IF_KW,
};
...
export const isKeyword: MatchRule = {
    key: 'is-keyword',
    scope: scopes.keywords.comparison,
    match: R.IS_KW,
};
